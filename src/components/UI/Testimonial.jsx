          ...
          <Slider {...settings}>
            <div className="slider__item">
              <p className="description">
                ...
                assumenda cum vitae sapiente blanditiis commodi nemo corporis
                porro dolor repellendus odit quod, cumque ab aut nulla explicabo
                nesciunt aperiam pariatur illo beatae debitis. Eveniet error
                dicta nam, ex incidunt porro.
              </p>
